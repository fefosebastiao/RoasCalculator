          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <CardContent className="p-6">
                ...
                <ul className="mt-4 space-y-2">
                  <li className="flex items-start">
                    ...
                    <span className="text-gray-700">Identifica campanhas lucrativas</span>
                  </li>
                  <li className="flex items-start">
                    <CheckIcon className="h-5 w-5 text-green-500 mt-0.5 mr-2" />
                  ...
                  <li className="flex items-start">
                    <CheckIcon className="h-5 w-5 text-green-500 mt-0.5 mr-2" />
                    <span className="text-gray-700">Estabelece metas realistas</span>
                  </li>
                </ul>
              </CardContent>
            </Card>
            ...
            <Card className="hover:shadow-md transition-shadow">
              <CardContent className="p-6">
                ...
                <p className="text-gray-600">
                  Nossa calculadora utiliza dados de benchmark do setor para contextualizar seu ROAS e fornecer recomendações personalizadas.
                </p>
                <div className="mt-4 space-y-3">
                  <div className="flex items-center">
                    <div className="w-3 h-3 rounded-full bg-red-500 mr-2"></div>
                    <span className="text-sm font-medium">ROAS &lt; 2x: Abaixo do ideal</span>
                  </div>
                  <div className="flex items-center">
                    <div className="w-3 h-3 rounded-full bg-yellow-500 mr-2"></div>
                    <span className="text-sm font-medium">ROAS 2-4x: Dentro da média</span>
                  </div>
                  <div className="flex items-center">
                    <div className="w-3 h-3 rounded-full bg-green-500 mr-2"></div>
                    <span className="text-sm font-medium">ROAS &gt; 4x: Excelente performance</span>
                  </div>
                </div>
              </CardContent>
            </Card>
